...
public class Algorithm_stack_monotonous_stack {
     ...
     *  input: 2, 1, 5, 3, 6, 4
     *
     *  规定限制买1卖1，所以统计邻接的由低到高的数据，即为最大盈利为： 7
     *  单调栈中只允许pop一次，不可以while循环pop出所有比自己小的数据。
     *
     *  假如修改算法如下： 买n卖n，求最大利益，如何操作
     *  可以使用单调栈，统计每次右边比当前数据大的数据，相差即为盈利，
     *  此时新入元素如果比栈顶数据大，则pop出来，同时while循环pop出所有
     *  比新元素小的栈中数据，相差总和则为最大盈利： 11
     */
    ...
    public static void main(String[] args) {
        Algorithm_stack_monotonous_stack processor = new Algorithm_stack_monotonous_stack();
